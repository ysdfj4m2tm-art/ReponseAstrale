...
export function AstroForm() {
  ...
  async function submit(data: AnalysisFormData){
    ...
    try {
      ...
      // This navigation intentionally leaves the form document after the static Netlify POST.
