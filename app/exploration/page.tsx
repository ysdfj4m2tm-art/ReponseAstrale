...
export default async function ExplorationPage({ searchParams }: { searchParams: Promise<{ token?: string; access?: string }> }) {
  ...
  return <PageShell><section className="section commercial-hero"><div className="shell commercial-grid"><div>
  ...
  </div><CheckoutForm chartToken={token || access} /></div></section></PageShell>;
}
